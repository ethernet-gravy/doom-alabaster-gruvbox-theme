;;; doom-alabaster-gruvbox-theme.el --- A light theme with little syntax highlighting -*- lexical-binding: t; no-byte-compile: t -*-
...
;; Homepage: https://github.com/ethernet-gravy/doom-alabaster-gruvbox-theme
...
;;;; Colors
  ...
  ((bg           '("#282828" "#282828"   "black"))
   ...
   (base4        '("#7C6F64" "#7C6F64"   "brightblack"))
   (base5        '("#ebdbb2" "#ebdbb2"   "white"))
   (base6        '("#ebdbb2" "#ebdbb2"   "white"))
   (base7        '("#ebdbb2" "#ebdbb2"   "white"))
   (base8        '("#ebdbb2" "#ebdbb2"   "white"))
   (fg           '("#ebdbb2" "#ebdbb2"   "white"))
   (fg-alt       '("#fbf1c7" "#fbf1c7"   "white"))
   (bg-alt       base0)

   (grey       base3)

   (red          '("#fb4934" "#fb4934"   "red"))
   (green        '("#b8bb26" "#b8bb26"   "green"))
   (yellow       '("#fabd2f" "#fabd2f"   "yellow"))
   (dark-blue    '("#83a598" "#83a598"   "blue"))
   (magenta      '("#d3869b" "#d3869b"   "magenta"))
   (dark-cyan    '("#689d6a" "#689d6a"   "cyan"))
   (light-yellow '("#fabd2f" "#fabd2f"   "brightyellow"))
   (orange       '("#fe8019" "#fe8019"   "brightred"))
   (teal         '("#b8bb26" "#b8bb26"   "brightgreen"))
