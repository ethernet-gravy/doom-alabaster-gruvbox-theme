...
Port of [[https://github.com/tonsky/sublime-scheme-alabaster][Alabaster]] to [[https://doomemacs.org][Doom Emacs]]. Gruvbox Style.
Original theme: [[https://github.com/agraul/doom-alabaster-theme][doom-alabaster-theme]]
...
1. Add =doom-alabaster-theme= to =$DOOMDIR/packages.el=
   #+begin_src elisp
;; $DOOMDIR/packages.el
(package! doom-alabaster-gruvbox-theme :recipe (:host github :repo "ethernet-gravy/doom-alabaster-gruvbox-theme"))
   #+end_src
2. Run ~doom sync~
3. Set =doom-theme= to ='doom-alabaster-gruvbox=
   #+begin_src elisp
;; $DOOMDIR/config.el
(setq doom-theme 'doom-alabaster-gruvbox)
   #+end_src
...
Doom Emacs by [[https://github.com/agraul][Alex Graul]]. Gruvbox spin created by [[https://github.com/ethernet-gravy][Ethernet Gravy]].
